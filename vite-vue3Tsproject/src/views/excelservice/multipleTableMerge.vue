<template>
  <div class="data-content">
    ...
    >
      <el-form :model="formInline" :rules="rules" label-width="140px">
        <el-form-item label="标题" prop="name">
          <el-input v-model="formInline.user" placeholder="请输入标题" />
        </el-form-item>
        <el-form-item label="excel唯一编号" prop="name">
          <el-input-number
        ...
        <el-form-item label="参与合并的excel" prop="name">
        ...
        <el-form-item label="描述">
          <el-input v-model="formInline.textarea" type="textarea" />
        </el-form-item>
      </el-form>
      <template #footer>
